...
## 2. 개발 내역
### 2.1. 개발 환경 세팅
- [package.json](file:///c:/Users/dlrjs/OneDrive/바탕 화면/대학교/webplatform/webplatform_git/webserviceplatform/webplatform_w8/package.json): Express.js 서버 구성에 필요한 모듈 정의 (cors, dotenv, pg). nodemon 개발 의존성을 추가해 개발 생산성 향상.
- [server.js](file:///c:/Users/dlrjs/OneDrive/바탕 화면/대학교/webplatform/webplatform_git/webserviceplatform/webplatform_w8/server.js):
...
### 2.2. 데이터베이스 구성
- [schema.sql](file:///c:/Users/dlrjs/OneDrive/바탕 화면/대학교/webplatform/webplatform_git/webserviceplatform/webplatform_w8/schema.sql): 6주차 ERD 명세를 반영한 DDL 스크립트 작성.
...
- [db.js](file:///c:/Users/dlrjs/OneDrive/바탕 화면/대학교/webplatform/webplatform_git/webserviceplatform/webplatform_w8/db.js):
